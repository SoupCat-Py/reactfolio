...
export default function Hero() {
    ...
    return (
        ...
        <section className={`d-flex flex-col align-start justify-start g2 zmax ${styles.container}`}>
            ...
            {/* the buttons */}
            <div className={`d-flex flex-row justify-start align-center g1 ${styles.buttonsRow}`}>
                {/* split the buttons into two groups so I can stack them on mobile layout */}
        ...
        {/* maple leaf */}
        {/* I'm not entirely sure what's going on with this SVG but it works */}
        <svg
